...
export class QueryChapterDto {
  @ApiProperty({
    description: "Search term for chapter name or description",
  ...
  @ApiProperty({
    description: "Filter chapters created from this date",
    example: "2024-01-01",
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: "Filter chapters created until this date",
    example: "2024-12-31",
    required: false,
  })
  @IsOptional()
