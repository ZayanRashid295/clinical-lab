...
export default function RideAnalytics() {
  ...
  return (
    <>
      <Head>
        <title>Ride Analytics - Uber Portal</title>
        <meta
          name="description"
          content="Comprehensive ride analytics and insights"
        />
        <meta
          name="keywords"
          content="rides, analytics, performance, insights"
        />
      </Head>
      ...
      <MenuSystem
        ...
        searchPlaceholder="Search ride analytics..."
        enableSearch={true}
      />
    </>
  );
