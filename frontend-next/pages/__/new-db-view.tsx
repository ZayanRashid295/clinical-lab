...
const ModuleManager = () => {
  const initialData: ProjectData = {
    ...
    description: "Clinical laboratory management system with modules for dashboard, content, and payments",
    modules: [
      {
  ...
  const allTables = [
    ...data.base,
    ...data.modules.flatMap((m) => m.tables),
  ];
      ...
      setData({
        ...
        modules: data.modules.map((m, idx) =>
          idx === selectedModuleIndex
            ? {
                ...m,
                tables: updateTablePosition(m.tables, draggingTable, newX, newY),
              }
            : m
        ),
      });
