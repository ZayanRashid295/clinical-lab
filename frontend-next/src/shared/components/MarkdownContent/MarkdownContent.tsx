...
const THEMES: Record<MarkdownVariant, Theme> = {
  ...
  bubbleMine: {
    ...
    link: "text-emerald-100 underline underline-offset-2 font-semibold break-words",
    codeInline:
      "rounded bg-emerald-700/90 px-1 py-0.5 text-[0.85em] font-mono text-white",
    codeBlock:
      "overflow-x-auto rounded-md bg-emerald-800/90 p-2 my-2 text-xs text-white",
    blockquoteBorder: "border-emerald-300/80",
    hr: "border-emerald-400/50",
    thTdBorder: "border-emerald-400/40",
    theadBg: "bg-emerald-800/50",
  },
  chatPatient: {
    text: "text-left text-gray-800",
    strong: "font-semibold text-gray-900",
    muted: "text-gray-700",
    link: "text-blue-600 underline font-medium break-words",
    codeInline: "bg-gray-100 px-1 py-0.5 rounded text-xs font-mono",
    codeBlock: "overflow-x-auto rounded-md bg-gray-100 p-2 my-2 text-xs text-gray-900",
    blockquoteBorder: "border-gray-300",
    hr: "border-gray-200",
    thTdBorder: "border-gray-200",
    theadBg: "bg-gray-100",
  },
  chatAccent: {
    ...
    strong: "font-semibold text-white",
    muted: "text-blue-50",
    link: "text-sky-100 underline font-semibold break-words",
    codeInline: "bg-blue-600/80 px-1 py-0.5 rounded text-xs font-mono text-white",
    codeBlock: "overflow-x-auto rounded-md bg-blue-700/80 p-2 my-2 text-xs text-white",
    blockquoteBorder: "border-blue-200/60",
    hr: "border-blue-200/40",
    thTdBorder: "border-blue-200/40",
    theadBg: "bg-blue-700/50",
  },
  bubbleDoctor: {
    text: "text-left text-rose-900",
    strong: "font-semibold text-rose-950",
    muted: "text-rose-800",
    link: "text-rose-700 underline font-semibold break-words",
    codeInline:
      "rounded bg-rose-100 px-1 py-0.5 text-xs font-mono text-rose-900",
    codeBlock:
      "overflow-x-auto rounded-md bg-rose-100/90 p-2 my-2 text-xs text-rose-900",
    blockquoteBorder: "border-rose-300",
    hr: "border-rose-200",
    thTdBorder: "border-rose-200",
    theadBg: "bg-rose-100/80",
  },
};
