...
interface OrgChartNodeHorizontalProps {
  node: FlatNode;
...
export const OrgChartNodeHorizontal: React.FC<OrgChartNodeHorizontalProps> = ({
  node,
  position,
  isDragging,
  isDragOver,
  ...
  return (
    <div key={node.id}>
      ...
      <div
        ...
        className={`rounded-lg shadow-xl border-2 overflow-hidden transition-all relative flex flex-row ${
          canDropAsChild
