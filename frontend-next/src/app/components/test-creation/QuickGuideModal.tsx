...
export function QuickGuideModal({ open, onOpenChange }: QuickGuideModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="gap-0 overflow-hidden border-slate-200/90 bg-white p-0 shadow-2xl dark:border-white/10 dark:bg-white/5 dark:backdrop-blur-md sm:max-w-2xl">
        <DialogHeader className="border-b border-slate-200/80 bg-gradient-to-br from-primary/5 via-transparent to-transparent px-6 pb-4 pt-6 dark:border-white/10 dark:from-primary/15">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-xl font-semibold text-foreground dark:text-slate-100">Quick Guide</DialogTitle>
                <DialogDescription className="text-sm text-muted-foreground dark:text-slate-400 mt-0.5">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-foreground dark:text-slate-100">Configure Test Settings</h3>
              </div>
              <p className="text-sm text-muted-foreground dark:text-slate-400 leading-relaxed">
                Enable <span className="font-medium text-foreground dark:text-slate-100">Tutor Mode</span> to see explanations after each
                question. Toggle <span className="font-medium text-foreground dark:text-slate-100">Timed Mode</span> for time-based
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-foreground dark:text-slate-100">Include Marked Questions</h3>
              </div>
              <p className="text-sm text-muted-foreground dark:text-slate-400 leading-relaxed">
                Enable <span className="font-medium text-foreground dark:text-slate-100">Include marked questions</span> to filter your test
              ...
              <div className="bg-muted/50 dark:bg-white/10 rounded-lg p-3 mt-2 flex items-start gap-2">
                ...
                <p className="text-xs text-muted-foreground dark:text-slate-400">
                  <span className="font-medium text-foreground dark:text-slate-100">Pro tip:</span> Mark questions during practice to build
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-foreground dark:text-slate-100">Select Question Pool</h3>
              </div>
              <p className="text-sm text-muted-foreground dark:text-slate-400 leading-relaxed">
                Filter questions by their status. Choose <span className="font-medium text-foreground dark:text-slate-100">Unused</span> for
                fresh questions,
                <span className="font-medium text-foreground dark:text-slate-100"> Correct</span> to revisit mastered content,
                <span className="font-medium text-foreground dark:text-slate-100"> Incorrect</span> to review mistakes, or
                <span className="font-medium text-foreground dark:text-slate-100"> Omitted</span> for skipped questions.
              </p>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-foreground dark:text-slate-100">Set Question Count</h3>
              </div>
              <p className="text-sm text-muted-foreground dark:text-slate-400 leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-foreground dark:text-slate-100">Generate Your Test</h3>
              </div>
              <p className="text-sm text-muted-foreground dark:text-slate-400 leading-relaxed">
                Once you&apos;ve configured all settings, click the{" "}
                <span className="font-medium text-foreground dark:text-slate-100">&quot;Generate Test&quot;</span> button to create your personalized
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-border/50 dark:border-white/10 bg-muted/30 dark:bg-white/10 flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm text-muted-foreground dark:text-slate-400">
            <Clock className="h-4 w-4" />
            <span>
              Average test creation time: <span className="font-medium text-foreground dark:text-slate-100">30 seconds</span>
            </span>
          </div>
