    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="sticky top-0 z-40 bg-card/95 backdrop-blur border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
          <div></div>
          <h1 className="text-lg sm:text-xl font-bold text-foreground">UWorld Clone</h1>
          <div></div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-3 sm:mb-4">UWorld Clone</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {/* Student Section */}
          <Card className="p-6 sm:p-8 hover:shadow-lg hover:border-primary/30 transition-all duration-300 group">
            <div className="mb-6">
              <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
                <span className="text-2xl">📚</span>
              </div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Student Mode</h2>
          ...
          {/* Admin Section */}
          <Card className="p-6 sm:p-8 hover:shadow-lg hover:border-secondary/30 transition-all duration-300 group">
            <div className="mb-6">
              <div className="w-12 h-12 bg-secondary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-secondary/20 transition-colors">
                <span className="text-2xl">⚙️</span>
              </div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Admin Mode</h2>
              <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <Card className="p-6 hover:shadow-md transition-all duration-200 hover:translate-y-[-2px]">
            <h3 className="font-semibold text-foreground mb-2">Rich Content Editor</h3>
          ...
          <Card className="p-6 hover:shadow-md transition-all duration-200 hover:translate-y-[-2px]">
            <h3 className="font-semibold text-foreground mb-2">Question Management</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <Card className="p-6 hover:shadow-md transition-all duration-200 hover:translate-y-[-2px]">
            <h3 className="font-semibold text-foreground mb-2">Student Experience</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        {/* Footer */}
        <div className="mt-12 sm:mt-16 pt-8 border-t border-border text-center text-sm text-muted-foreground">
