...
export default function QuestionGeneratorStudent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-background dark:from-gray-900 via-background dark:via-gray-900 to-background/95 dark:to-gray-900/95">
