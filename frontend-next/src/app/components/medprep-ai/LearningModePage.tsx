  ...
  return (
    <ModeLandingPage
      config={{
        ...
        directStartSuccessRoute: (caseId, specialty) => `/medprep-ai/learn/${caseId}?specialty=${specialty}&generated=true`,
        directStartFallbackRoute: (caseId, specialty) => `/medprep-ai/learn/${caseId}?specialty=${specialty}`,
        accent: {
