  ...
  return (
    <ModeLandingPage
      config={{
        ...
        directStartSuccessRoute: (caseId, specialty) => `/medprep-ai/practice-nurse-report?caseId=${caseId}&specialty=${specialty}&generated=true`,
        directStartFallbackRoute: (caseId, specialty) => `/medprep-ai/practice-nurse-report?caseId=${caseId}&specialty=${specialty}`,
        accent: {
