        ...
        <div className="space-y-4">
          <div>
            ...
            <RadioGroup value={mode} onValueChange={(v) => onModeChange(v as "tutor" | "timed")}>
              <div className="flex items-start space-x-3 p-3 rounded-lg border border-border hover-elevate">
              ...
              <div className="flex items-start space-x-3 p-3 rounded-lg border border-border hover-elevate">
                ...
                <div className="flex-1">
                  <Label htmlFor="timed" className="font-medium cursor-pointer">
                    Timed
                  </Label>
                  <p className="text-sm text-muted-foreground mt-1">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg border border-border">
            <div className="flex-1">
              <Label htmlFor="time-accommodation" className="font-medium">
                Time Accommodation
              </Label>
              <p className="text-sm text-muted-foreground mt-1">
