...
const Login: React.FC = () => {
  ...
  const getThemeGradient = (): string => {
    ...
    // Use CSS custom properties instead of template literals to avoid build issues
    return "from-secondary-900 via-primary-700 to-primary-900";
  };
        ...
        <div className="max-w-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <span className="text-lg">🚗</span>
                <span className="flex-1 font-medium">{t("common.driver")}</span>
              </button>
              <button
                type="button"
                onClick={() =>
              ...
              >
                ...
                <span className="flex-1 font-medium">{t("common.admin")}</span>
              </button>
              <button
                type="button"
                onClick={() =>
