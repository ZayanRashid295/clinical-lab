...
export class ColorSchemesService {
  private readonly colorSchemes: Record<string, ColorScheme> = {
    blue: {
      primary: {
        50: "#eff6ff",
        100: "#dbeafe",
  ...
  getColorScheme(name: string): ColorScheme {
    return this.colorSchemes[name] || this.colorSchemes["blue"];
  }
...
export const colorSchemesService = new ColorSchemesService();
