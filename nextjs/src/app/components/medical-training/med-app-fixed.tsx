                ...
                >
                  ...
                  {simulationActive ? (
                    <div className="space-y-3">
                      {currentData.diagnoses.map((diagnosis, idx) => (
                        <div
                          key={idx}
                    ...
                    >
                      Start simulation to see diagnoses
                    </p>
                  )}
                </div>
              </div>
                  ...
                  {simulationActive ? (
                    <div className="space-y-3">
                      ...
                      <div className="bg-green-100 rounded-lg p-3 border-l-4 border-green-500">
                        <div className="font-semibold text-green-900 mb-1 text-xs">
                          Patient:
                        </div>
                        <div className="text-gray-800 text-sm">
                          {currentData.patient}
                      ...
                      <div className="flex justify-center pt-2">
                        <button
                          ...
                          disabled={
                            currentDialogue === dialogueSequence.length - 1
                          }
                          className="px-4 py-2 text-white rounded-lg text-sm font-semibold transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                          style={{
                            backgroundColor:
                              currentDialogue === dialogueSequence.length - 1
                                ? "#9CA3AF"
