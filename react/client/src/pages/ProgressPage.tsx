...
export default function ProgressPage() {
  ...
  const [selectedCompetency, setSelectedCompetency] = useState<string | null>("History Taking");
  ...
  const getTimeSeriesData = (competencyName: string) => {
    ...
    return [
      ...
      { week: "Week 3", score: Math.round(startScore + totalGrowth * 0.30) },
      { week: "Week 4", score: Math.round(startScore + totalGrowth * 0.45) },
      { week: "Week 5", score: Math.round(startScore + totalGrowth * 0.60) },
      { week: "Week 6", score: Math.round(startScore + totalGrowth * 0.75) },
      { week: "Week 7", score: Math.round(startScore + totalGrowth * 0.90) },
          ...
          <main className="flex-1 overflow-auto p-8">
            <div className="max-w-7xl mx-auto space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">Track your performance across core clinical competencies</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Cases Done</p>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <Card className="p-6 flex-1 md:w-1/2">
                  <h2 className="text-xl font-bold mb-6">Clinical Competencies</h2>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              size="icon"
                              className="h-5 w-5"
                              onClick={() => setSelectedCompetency(competency.name)}
                              data-testid={`button-info-${competency.name.toLowerCase().replace(/\s+/g, '-')}`}
                            >
                ...
                <Card className="p-6 flex-1 md:w-1/2">
                  ...
                  {selectedCompetency ? (
                    <div>
                      <p className="text-sm text-muted-foreground mb-4">{selectedCompetency}</p>
